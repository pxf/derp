...
\section{Editor Core}
To enable us to have greatest possible freedom when creating the pipline components later on, in regards to look and functionality, we decided to create our own GUI system for the editor. This however meant that we would have to recreate standard GUI widgets such as labels, textboxes and buttons. 
