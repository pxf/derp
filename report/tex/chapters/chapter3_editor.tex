...
aoeaoeaoeoa
\pic[0.7]{img/application_scripts.png}{Application script body. \textsuperscript{1)} Function that will be called when the application needs to redraw itself, usually when the script itself notifies this with }
