...
Performance tests were run on 4 clients on the Lightning network, with a total of 10 CPU cores combined. Two different scenes were tested, each with 6 different settings on how the image were divided (task count).
...
manner, which introduced an unecesary amount of complexity to the development
...
and between clients and the tracker did not support this design methadology very
well either.
