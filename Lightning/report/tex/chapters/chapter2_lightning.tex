...
\begin{enumerate}
  \item A job initiator prepares and package both job data and tasks and later transmits these a client in the cloud. An example of a job initiator would be a plugin for a 3D modelling application.
