...
\begin{enumerate}
  \item A job initiator prepares and package both job data and tasks, and later transmits these to a client in the cloud. An example of a job initiator would be a plugin for a 3D modeling application, or a standalone model viewer as this report describes.
